    ...
    return (
        <div className="dashboard">
            ...
            <div className="corpo-menu-vertical">
                ...
                <Link to="/configuracoes" className="item-menu-vertical" id="ativo">
                    <FaCogs className="img-item-menu-vertical" id="ativo-icon"/>
                    <h1 className="nome-item-menu-vertical" id="ativo-texto">Configurações</h1>
                </Link>
